...
user_two = User.create(username: "Nikky", email: "nicky254@gmail.com", password: "niccky245")
...
p_2 = Product.create(title: "bag", image_url: "https://www.cittadesign.com/market-bag/5637394358.p", description: "lorem", price: 44.50, supplier_id: supplier_one.id)
...
review_two = Review.create(review_content: "this is review content for the product", user_id: user_two.id, product_id: p_2.id)
